...
const UNIVERSE: Record<string, UniverseEntry> = {
  ...
  // ── ADDITIONAL HALAL-SCREENED STOCKS (from verified list) ─────────────────
  AAON : { halal:'high',    sector:'Manufacturing', tier:'large', description:'AAON — commercial HVAC equipment manufacturer' },
  ACAD : { halal:'high',    sector:'BioTech', tier:'small', description:'Acadia Pharmaceuticals — CNS drug development' },
  ADPT : { halal:'high',    sector:'BioTech', tier:'small', description:'Adaptive Biotechnologies — immune medicine diagnostics' },
  ADUS : { halal:'high',    sector:'Healthcare', tier:'large', description:'Addus HomeCare — home health and personal care services' },
  AEO  : { halal:'high',    sector:'Retail', tier:'small', description:'American Eagle Outfitters — casual apparel retail' },
  ALKS : { halal:'high',    sector:'BioTech', tier:'medium', description:'Alkermes — CNS disease treatments and drug delivery' },
  AMBA : { halal:'high',    sector:'Semiconductors', tier:'medium', description:'Ambarella — edge AI computer vision chips for cameras' },
  AMKR : { halal:'high',    sector:'Semiconductors', tier:'large', description:'Amkor Technology — semiconductor packaging and test' },
  ANIK : { halal:'high',    sector:'Healthcare', tier:'small', description:'Anika Therapeutics — orthobiologics and joint health' },
  AOS  : { halal:'high',    sector:'Manufacturing', tier:'large', description:'A.O. Smith — residential and commercial water heaters' },
  APG  : { halal:'high',    sector:'Manufacturing', tier:'medium', description:'APi Group — safety and specialty services' },
  APLS : { halal:'high',    sector:'BioTech', tier:'medium', description:'Apellis Pharmaceuticals — complement system drug pipeline' },
  ARLO : { halal:'high',    sector:'IoT', tier:'small', description:'Arlo Technologies — smart home security cameras' },
  ARWR : { halal:'high',    sector:'BioTech', tier:'large', description:'Arrowhead Pharmaceuticals — RNAi therapeutics pipeline' },
  ATRC : { halal:'high',    sector:'Medical Devices', tier:'small', description:'AtriCure — surgical ablation for atrial fibrillation' },
  AVDL : { halal:'high',    sector:'Pharma', tier:'small', description:'Avadel Pharmaceuticals — specialty pharma focus' },
  AZTA : { halal:'high',    sector:'Semiconductors', tier:'small', description:'Azenta — semiconductor equipment and life sciences storage' },
  BCC  : { halal:'high',    sector:'Manufacturing', tier:'large', description:'Boise Cascade — wood products and building materials' },
  BFAM : { halal:'high',    sector:'Education', tier:'large', description:'Bright Horizons — employer-sponsored childcare services' },
  BHP  : { halal:'high',    sector:'Materials', tier:'large', description:'BHP Group — diversified mining (iron ore, copper, coal)' },
  BKR  : { halal:'high',    sector:'Energy', tier:'medium', description:'Baker Hughes — oilfield services and industrial tech' },
  BLDR : { halal:'high',    sector:'Manufacturing', tier:'large', description:'Builders FirstSource — building materials and construction' },
  BMRN : { halal:'high',    sector:'BioTech', tier:'medium', description:'BioMarin — rare genetic disease therapies' },
  BOX  : { halal:'high',    sector:'Cloud', tier:'small', description:'Box — cloud content management and file sharing platform' },
  BRKR : { halal:'high',    sector:'Life Sciences', tier:'medium', description:'Bruker — scientific instruments for research and industry' },
  BROS : { halal:'high',    sector:'Beverages', tier:'medium', description:'Dutch Bros — fast-growing drive-through coffee chain' },
  BRZE : { halal:'high',    sector:'SaaS', tier:'small', description:'Braze — customer engagement and lifecycle marketing platform' },
  BSX  : { halal:'high',    sector:'Medical Devices', tier:'large', description:'Boston Scientific — medical devices for heart and urology' },
  BSY  : { halal:'high',    sector:'SaaS', tier:'medium', description:'Bentley Systems — infrastructure engineering software' },
  CALX : { halal:'high',    sector:'Telecom Tech', tier:'medium', description:'Calix — broadband access systems for service providers' },
  CARG : { halal:'high',    sector:'Automotive', tier:'medium', description:'CarGurus — online automotive marketplace' },
  CARR : { halal:'high',    sector:'Industrial', tier:'large', description:'Carrier Global — HVAC, refrigeration, and fire safety' },
  CGNX : { halal:'high',    sector:'Industrial', tier:'medium', description:'Cognex — machine vision systems for manufacturing' },
  CHD  : { halal:'high',    sector:'Consumer', tier:'large', description:'Church & Dwight — Arm & Hammer, OxiClean, Waterpik' },
  CL   : { halal:'high',    sector:'Consumer', tier:'large', description:'Colgate-Palmolive — oral care, personal care, and pet nutrition' },
  CLBT : { halal:'high',    sector:'SaaS', tier:'small', description:'Cellebrite — digital intelligence for investigations' },
  CLMB : { halal:'high',    sector:'Distribution', tier:'small', description:'Climb Global Solutions — technology product distribution' },
  CNM  : { halal:'high',    sector:'Distribution', tier:'medium', description:'Core & Main — waterworks and fire protection distribution' },
  COLM : { halal:'high',    sector:'Apparel', tier:'large', description:'Columbia Sportswear — outdoor apparel and footwear' },
  CORT : { halal:'high',    sector:'BioTech', tier:'medium', description:'Corcept Therapeutics — cortisol modulation drugs' },
  CP   : { halal:'high',    sector:'Transportation', tier:'large', description:'Canadian Pacific Kansas City — transcontinental freight railroad' },
  CPRI : { halal:'high',    sector:'Apparel', tier:'small', description:'Capri Holdings — Michael Kors, Versace, Jimmy Choo' },
  CPRT : { halal:'high',    sector:'Automotive', tier:'medium', description:'Copart — online vehicle auction and remarketing' },
  CTRA : { halal:'high',    sector:'Energy', tier:'medium', description:'Coterra Energy — natural gas and oil E&P' },
  CTVA : { halal:'high',    sector:'Agriculture', tier:'large', description:'Corteva — crop protection and seed technology' },
  CVLT : { halal:'high',    sector:'Cloud', tier:'large', description:'Commvault — data protection and cyber resilience platform' },
  DCBO : { halal:'high',    sector:'SaaS', tier:'small', description:'Docebo — AI-powered learning management platform' },
  DD   : { halal:'high',    sector:'Materials', tier:'medium', description:'DuPont — specialty materials and electronics solutions' },
  DGII : { halal:'high',    sector:'IoT', tier:'medium', description:'Digi International — IoT connectivity solutions' },
  DLO  : { halal:'high',    sector:'Fintech', tier:'small', description:'dLocal — payment processing for emerging markets' },
  DOCU : { halal:'high',    sector:'SaaS', tier:'medium', description:'DocuSign — e-signature and agreement cloud platform' },
  DT   : { halal:'high',    sector:'Cloud', tier:'medium', description:'Dynatrace — AI-powered observability and security platform' },
  DXCM : { halal:'high',    sector:'Medical Devices', tier:'large', description:'DexCom — continuous glucose monitoring systems' },
  ENPH : { halal:'high',    sector:'Clean Energy', tier:'medium', description:'Enphase Energy — microinverters and solar energy systems' },
  ESTC : { halal:'high',    sector:'Cloud', tier:'medium', description:'Elastic — search-powered solutions and observability' },
  EW   : { halal:'high',    sector:'Medical Devices', tier:'large', description:'Edwards Lifesciences — heart valves and hemodynamic monitoring' },
  EXE  : { halal:'high',    sector:'Energy', tier:'large', description:'Expand Energy — natural gas E&P in Appalachian basin' },
  EXEL : { halal:'high',    sector:'BioTech', tier:'medium', description:'Exelixis — oncology drug development, cabozantinib' },
  EXTR : { halal:'high',    sector:'Networking', tier:'small', description:'Extreme Networks — cloud-managed networking solutions' },
  FIGS : { halal:'high',    sector:'Apparel', tier:'small', description:'FIGS — premium medical scrubs and healthcare apparel' },
  FIVN : { halal:'high',    sector:'Cloud', tier:'small', description:'Five9 — cloud contact center software and AI' },
  FIZZ : { halal:'high',    sector:'Beverages', tier:'medium', description:'National Beverage — LaCroix sparkling water brands' },
  FND  : { halal:'high',    sector:'Retail', tier:'medium', description:'Floor & Decor — hard surface flooring retail superstores' },
  FOLD : { halal:'high',    sector:'BioTech', tier:'small', description:'Amicus Therapeutics — rare disease therapies' },
  FTNT : { halal:'high',    sector:'Cybersecurity', tier:'large', description:'Fortinet — network security appliances and cloud services' },
  FTV  : { halal:'high',    sector:'Industrial', tier:'large', description:'Fortive — industrial technology and precision instruments' },
  GDDY : { halal:'high',    sector:'SaaS', tier:'large', description:'GoDaddy — web hosting, domains, and small business tools' },
  GFS  : { halal:'high',    sector:'Semiconductors', tier:'medium', description:'GlobalFoundries — semiconductor manufacturing foundry' },
  GGG  : { halal:'high',    sector:'Manufacturing', tier:'large', description:'Graco — fluid handling equipment and systems' },
  GLBE : { halal:'high',    sector:'E-Commerce', tier:'medium', description:'Global-E Online — cross-border e-commerce technology' },
  GMED : { halal:'high',    sector:'Medical Devices', tier:'large', description:'Globus Medical — spine and orthopedic implants' },
  GNTX : { halal:'high',    sector:'Automotive', tier:'small', description:'Gentex — auto-dimming mirrors and connected car tech' },
  GSK  : { halal:'high',    sector:'Pharma', tier:'medium', description:'GSK — vaccines, respiratory and HIV medicines' },
  HAL  : { halal:'high',    sector:'Energy', tier:'medium', description:'Halliburton — oilfield services and equipment' },
  HLIT : { halal:'high',    sector:'Networking', tier:'small', description:'Harmonic — video streaming and cable access infrastructure' },
  HOLX : { halal:'high',    sector:'Medical Devices', tier:'large', description:"Hologic — women's health diagnostics and surgical products" },
  IMAX : { halal:'high',    sector:'Entertainment', tier:'medium', description:'IMAX — premium large-format cinema technology' },
  INCY : { halal:'high',    sector:'BioTech', tier:'large', description:'Incyte — oncology and inflammation drug pipeline' },
  INOD : { halal:'high',    sector:'Semiconductors', tier:'medium', description:'Innodata — AI data annotation and digital services' },
  INSP : { halal:'high',    sector:'Medical Devices', tier:'medium', description:'Inspire Medical — implantable sleep apnea treatment' },
  IOT  : { halal:'high',    sector:'IoT/Cloud', tier:'medium', description:'Samsara — connected operations platform for fleet and assets' },
  IR   : { halal:'high',    sector:'Industrial', tier:'large', description:'Ingersoll Rand — industrial equipment and compression tech' },
  KLIC : { halal:'high',    sector:'Semiconductors', tier:'large', description:'Kulicke & Soffa — semiconductor assembly equipment' },
  KMB  : { halal:'high',    sector:'Consumer', tier:'large', description:'Kimberly-Clark — consumer tissue and hygiene products' },
  KNX  : { halal:'high',    sector:'Transportation', tier:'large', description:'Knight-Swift — truckload transportation and logistics' },
  KVYO : { halal:'high',    sector:'SaaS', tier:'small', description:'Klaviyo — email and SMS marketing automation platform' },
  LEN  : { halal:'high',    sector:'Real Estate', tier:'large', description:'Lennar — homebuilder focused on entry-level and move-up' },
  LEVI : { halal:'high',    sector:'Apparel', tier:'small', description:'Levi Strauss — iconic denim and apparel brand' },
  LOGI : { halal:'high',    sector:'Consumer Tech', tier:'large', description:'Logitech — peripherals, webcams, gaming accessories' },
  LQDA : { halal:'high',    sector:'BioTech', tier:'small', description:'Liquidia — pulmonary hypertension drug development' },
  MCHP : { halal:'high',    sector:'Semiconductors', tier:'large', description:'Microchip Technology — microcontrollers and analog chips' },
  MDT  : { halal:'high',    sector:'Medical Devices', tier:'large', description:'Medtronic — cardiac, spine, and diabetes medical devices' },
  MGNI : { halal:'high',    sector:'Ad Tech', tier:'small', description:'Magnite — independent sell-side advertising platform' },
  MNSO : { halal:'high',    sector:'Retail', tier:'small', description:'MNSO — affordable lifestyle product retail chain' },
  MNST : { halal:'high',    sector:'Beverages', tier:'large', description:'Monster Beverage — energy drinks and alternative beverages' },
  MSM  : { halal:'high',    sector:'Distribution', tier:'large', description:'MSC Industrial — metalworking and maintenance supplies' },
  NIKE : { halal:'high',    sector:'Apparel', tier:'medium', description:'Nike — global athletic footwear and apparel leader' },
  NTNX : { halal:'high',    sector:'Cloud', tier:'medium', description:'Nutanix — hyper-converged infrastructure and cloud software' },
  OLLI : { halal:'high',    sector:'Retail', tier:'large', description:"Ollie's Bargain Outlet — closeout retail merchandise" },
  OMCL : { halal:'high',    sector:'Healthcare', tier:'medium', description:'Omnicell — pharmacy automation and medication management' },
  ONON : { halal:'high',    sector:'Apparel', tier:'medium', description:'On Holding — premium performance running shoes and apparel' },
  OOMA : { halal:'high',    sector:'Cloud', tier:'small', description:'Ooma — cloud-based communications for business and home' },
  OPCH : { halal:'high',    sector:'Healthcare', tier:'small', description:'Option Care Health — home and alternate site infusion' },
  ORLY : { halal:'high',    sector:'Retail', tier:'large', description:"O'Reilly Auto Parts — automotive parts retail and distribution" },
  OTIS : { halal:'high',    sector:'Industrial', tier:'large', description:'Otis — elevators, escalators, and moving walkways' },
  PAY  : { halal:'high',    sector:'Fintech', tier:'small', description:'Paymentus — cloud bill payment solutions' },
  PCOR : { halal:'high',    sector:'SaaS', tier:'medium', description:'Procore Technologies — construction management platform' },
  PGNY : { halal:'high',    sector:'Healthcare', tier:'small', description:'Progyny — fertility benefits management platform' },
  POWI : { halal:'high',    sector:'Semiconductors', tier:'medium', description:'Power Integrations — energy-efficient power conversion ICs' },
  PSTG : { halal:'high',    sector:'Cloud', tier:'large', description:'Pure Storage — flash-based data storage systems' },
  QLYS : { halal:'high',    sector:'Cybersecurity', tier:'large', description:'Qualys — cloud-based security and compliance platform' },
  QRVO : { halal:'high',    sector:'Semiconductors', tier:'large', description:'Qorvo — RF chips for mobile and defense applications' },
  RAMP : { halal:'high',    sector:'Ad Tech', tier:'small', description:'LiveRamp — data connectivity and identity platform' },
  RBLX : { halal:'medium',    sector:'Gaming', tier:'medium', description:'Roblox — user-generated gaming and metaverse platform' },
  RDNT : { halal:'high',    sector:'Healthcare', tier:'large', description:'RadNet — outpatient radiology and imaging centers' },
  RELY : { halal:'high',    sector:'Fintech', tier:'small', description:'Remitly — digital international remittance platform' },
  RHI  : { halal:'high',    sector:'Staffing', tier:'small', description:'Robert Half — professional staffing and consulting' },
  ROL  : { halal:'high',    sector:'Services', tier:'medium', description:'Rollins — pest and termite control services' },
  RRC  : { halal:'high',    sector:'Energy', tier:'medium', description:'Range Resources — natural gas E&P in Appalachian basin' },
  RVLV : { halal:'high',    sector:'E-Commerce', tier:'small', description:'Revolve — online fashion retail for millennial women' },
  SBUX : { halal:'high',    sector:'Beverages', tier:'large', description:'Starbucks — global coffee chain and loyalty ecosystem' },
  SCVL : { halal:'high',    sector:'Retail', tier:'small', description:'Shoe Carnival — family footwear retail chain' },
  SEDG : { halal:'high',    sector:'Clean Energy', tier:'medium', description:'SolarEdge — solar inverters and energy optimization' },
  SEMR : { halal:'high',    sector:'SaaS', tier:'small', description:'Semrush — SEO and digital marketing analytics platform' },
  SHOO : { halal:'high',    sector:'Apparel', tier:'medium', description:'Steve Madden — fashion footwear and accessories' },
  SKY  : { halal:'high',    sector:'Manufacturing', tier:'large', description:'Skyline Champion — manufactured and modular homes' },
  SLB  : { halal:'high',    sector:'Energy', tier:'medium', description:'SLB (Schlumberger) — oilfield technology and services' },
  SMCI : { halal:'high',    sector:'Servers', tier:'small', description:'Super Micro Computer — AI server and data center hardware' },
  SNDR : { halal:'high',    sector:'Transportation', tier:'small', description:'Schneider National — truckload and intermodal logistics' },
  SONO : { halal:'high',    sector:'Consumer Tech', tier:'small', description:'Sonos — premium wireless home audio systems' },
  SPSC : { halal:'high',    sector:'SaaS', tier:'medium', description:'SPS Commerce — cloud supply chain management platform' },
  STAA : { halal:'high',    sector:'Medical Devices', tier:'small', description:'STAAR Surgical — implantable lenses for vision correction' },
  STM  : { halal:'high',    sector:'Semiconductors', tier:'medium', description:'STMicroelectronics — automotive and industrial chips' },
  SWKS : { halal:'high',    sector:'Semiconductors', tier:'medium', description:'Skyworks Solutions — RF chips for smartphones and IoT' },
  TDC  : { halal:'high',    sector:'Cloud', tier:'small', description:'Teradata — cloud analytics and data warehousing' },
  TEAM : { halal:'high',    sector:'SaaS', tier:'large', description:'Atlassian — Jira, Confluence, collaboration software' },
  TENB : { halal:'high',    sector:'Cybersecurity', tier:'small', description:'Tenable — vulnerability management and exposure platform' },
  TGTX : { halal:'high',    sector:'BioTech', tier:'medium', description:'TG Therapeutics — oncology and autoimmune drugs' },
  TILE : { halal:'high',    sector:'Manufacturing', tier:'small', description:'Interface — modular carpet tile and flooring' },
  TNDM : { halal:'high',    sector:'Medical Devices', tier:'small', description:'Tandem Diabetes — insulin pump systems' },
  TREX : { halal:'high',    sector:'Manufacturing', tier:'medium', description:'Trex Company — composite decking and railing products' },
  TRMB : { halal:'high',    sector:'Technology', tier:'large', description:'Trimble — GPS positioning and construction technology' },
  TSCO : { halal:'high',    sector:'Retail', tier:'medium', description:'Tractor Supply — rural lifestyle retail stores' },
  TTD  : { halal:'high',    sector:'Ad Tech', tier:'small', description:'The Trade Desk — programmatic advertising platform, DSP leader' },
  TTEK : { halal:'high',    sector:'Engineering', tier:'medium', description:'Tetra Tech — engineering and environmental consulting' },
  UBER : { halal:'high',    sector:'Transportation', tier:'large', description:'Uber — ride-hailing, food delivery, and freight' },
  UFPI : { halal:'high',    sector:'Manufacturing', tier:'large', description:'UFP Industries — wood composite and packaging products' },
  VCEL : { halal:'high',    sector:'BioTech', tier:'medium', description:'Vericel — cell therapy for cartilage and burn treatment' },
  VERX : { halal:'high',    sector:'SaaS', tier:'small', description:'Vertex — tax compliance software for businesses' },
  VRRM : { halal:'high',    sector:'Transportation', tier:'small', description:'Vontier — toll and traffic management systems' },
  WGO  : { halal:'high',    sector:'Consumer', tier:'medium', description:'Winnebago Industries — recreational vehicles and marine' },
  WIX  : { halal:'high',    sector:'SaaS', tier:'large', description:'Wix.com — cloud website builder and business platform' },
  WK   : { halal:'high',    sector:'SaaS', tier:'medium', description:'Workiva — cloud compliance and financial reporting' },
  WY   : { halal:'high',    sector:'Real Estate', tier:'small', description:'Weyerhaeuser — timber REIT and wood products' },
  XPEL : { halal:'high',    sector:'Automotive', tier:'medium', description:'XPEL — paint protection film and automotive window film' },
  YETI : { halal:'high',    sector:'Consumer', tier:'medium', description:'YETI Holdings — premium coolers, drinkware, and outdoor gear' },
  ZTO  : { halal:'high',    sector:'Logistics', tier:'small', description:'ZTO Express — China express delivery network' },
};
